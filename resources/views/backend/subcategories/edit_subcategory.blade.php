		...
		<div id="tabs" class="lg:text-xl">
			...
			<div class="grid grid-cols-4 gap-4">
					...
					<div class="lg:col-span-1 md:col-span-1 sm:col-span-4 col-span-4 bg-white h-content shadow-xl rounded-xl">
						<div class="abc">
							<ul class="w_ful">
								<li><a href="#tabs-1" class="w_full pl-12" onclick="appendTabUrl('#tabs-1')">{{ __('Edit Sub Category') }}</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="lg:col-span-3 md:col-span-3 sm:col-span-4 col-span-4 bg-white shadow-xl rounded-xl">
						<div class="tab-contentss">
							...
							{{-- ============= tab-1 of Add Sub Category  ================= --}}

							<div id="tabs-1">
				        		
				        		<h1 class="text-xl font-bold lg:px-16 md:px-8 sm:px-2 px-2 py-10 border-b border-gray-300 text-base"> {{ __('Edit Sub Category') }}</h1>
				 				<strong class="ml-16"><span class="text-red-600">* </span>shows that these are required fields.</strong>
				        		<!-- Start: Post Project Form -->
				        			@include('backend.forms.edit.edit_subcategory')
