		...
		<div class="grid grid-cols-4 gap-4 border-b border-gray-300 text-base">
			...
			<div class="lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-4 bg-red">
				<div class="my-2 text-sm">
	                ...
	                <textarea id="{{$form_data['description']}}" name="{{$form_data['description']}}" type="text" autofocus id="{{$form_data['description']}}" class="rounded-sm focus:outline-none text-sm bg-gray-100 w-full" placeholder="Describe about the post." rows="3"/>{{ old($form_data['description']) }}</textarea>
	            </div>
	        </div>
