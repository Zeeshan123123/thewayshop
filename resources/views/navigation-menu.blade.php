        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(Auth::user()->role == 'admin' )
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('subcategories') }}" :active="request()->routeIs('subcategories')">
                            {{ __('Sub Cats.') }}
                        </x-jet-nav-link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('coupens') }}" :active="request()->routeIs('coupens')">
                            {{ __('Coupens') }}
                        </x-jet-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('currencies') }}" :active="request()->routeIs('currencies')">
                            {{ __('Currencies') }}
                        </x-jet-nav-link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('admin.orders') }}" :active="request()->routeIs('activity.logs')">
                            {{ __('Orders') }}
                        </x-jet-nav-link>
                    </div>
