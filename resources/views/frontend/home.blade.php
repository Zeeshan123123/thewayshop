...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('assets/images/t-shirts-img.jpg') }}" alt="" />
                        <a class="btn hvr-hover" href="#">T-shirts</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('assets/images/shirt-img.jpg') }}" alt="" />
                        <a class="btn hvr-hover" href="#">Shirt</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('assets/images/wallet-img.jpg') }}" alt="" />
                        <a class="btn hvr-hover" href="#">Wallet</a>
                    </div>
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('assets/images/women-bag-img.jpg') }}" alt="" />
                        <a class="btn hvr-hover" href="#">Bags</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="{{ asset('assets/images/shoes-img.jpg') }}" alt="" />
                    ...
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            @if( $product->images->count() > 0 )
                                <img src="{{ getImage($product->images[0]->image) }}" class="img-fluid cus-height" alt="Image"/>
                            @else
                                <img src="https://dummyimage.com/255x330/949494/fff" class="img-fluid cus-height" alt="Image">
                            @endif
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="{{ route('product.show.detail',["id"=>Crypt::encrypt($product->id)]) }}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                    {{-- <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li> --}}
                                    <li>
                                        <a href="" onclick="addToWishList('{{ $product->id }}')" data-toggle="tooltip" data-placement="right" title="Add to Favourites">
                                            <i class="far fa-heart"></i>
                                        </a>
                                    </li> 
                                </ul>
                                <a class="cart" href="" onclick="addToCart('{{ $product->id }}')">Add to Cart</a>
                            </div>
                        </div>
                       
                        <div class="why-text">
                            <h4>{!! \Illuminate\Support\Str::limit( $product->short_description, 30, $end='...' ) !!}</h4>
    ...
    <div class="instagram-box">
        <div class="main-instagram owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{ asset('assets/images/instagram-img-10.jpg') }}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
