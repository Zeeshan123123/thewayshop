...
{{--                                                            <p class="sale">Sale</p>--}}
{{--                                                        </div>--}}
{{--                                                        @dump($product->images[0]->image)--}}
                                                        <img src="{{ getImage($product->images[0]->image) }}" class="img-fluid" alt="{{ $product->title }}">
                                                        <div class="mask-icon">
                                                            <ul>
...
{{--                                                                <p class="new">New</p>--}}
{{--                                                            </div>--}}
                                                            <img src="{{ getImage($product->images[0]->image) }}" class="img-fluid" alt="Image">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
