...
// ** Will change prefix for reference_id at Line:48 && category at Line:82 in future;
...
class PaypalService
{
    ...
    private function simpleCheckoutData($orderId)
    {
        ...
        return [
            "intent" => "CAPTURE", // intent has two options: Capture Or Authorization(just getting order, will charge the customer later);
            "purchase_units" => [[
                "reference_id" => 'ecommerce_'. uniqid(),
                "amount" => [
